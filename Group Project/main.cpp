/* This program was created by Shelbie Kakalec and [put name here] for CMSC-202 on December 8th, 2025.
...
int main()
{
    ...
    string size;
    bool debug;
    cout << "Do you want to use a single link list or double link list(1 for single 2 for double): " << endl;
    cin >> SD;
    if (SD == 2)
    {
        doubleLink = true;
